...
def main():
    parser = argparse.ArgumentParser(description="Visualize 3D volume data using PyVista")
    parser.add_argument(
        '--input', type=str,
    ...
    # For binary data a threshold of 0.5 works well.
